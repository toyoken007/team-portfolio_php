...
<body>
  ...
  <main class="recruit_page">
    <div class="recruit_wrap">
      ...
      <div class="recruit_image"> <img src="../images/recruit/recruit.jpg" alt="ギャラリーのイメージ画像"></div>
    </div>
    <div class="recruit_wrapwrap">
      <div class="recruit_comment_box">
        <div class="recruit_h4">
          <h4>「愛」「真心」「美」「感動」を与える。</h4>
        </div>
        <div class="recruit_comment">
          <p>当社の経営理念にもあるように、お客様に美と感動を与えるためには「愛」と「真心」が不可欠です。心を込めておもてなしすれば必ずお客様に伝わり、そしてあなたにとって必ず大切なお客様となります。<br></p>
          お客様のためを想う気持ちさえあれば、ここには成長出来る環境が揃っています。共に感動し、共に楽しく働きましょう。
        </div>
      </div>
      <div class="recruit_img"> <img src="../images/recruit/hasami.jpg" alt="ギャラリーのイメージ画像"></div>
    </div>
      ...
      <div class="requirements_wrap">
        ...
        <table>
          <tbody>
            <tr>
              <th>募集職種</th>
              <td>スタイリスト、アシスタント、2ヶ月間の研修期間あり</td>
            </tr>
            <tr>
              <th>勤務地</th>
              <td>
                <p>熊本県球磨郡あさぎり町0-0-0 2F</p>
                <p>熊本県人吉市0-0</p>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <th>給料</th>
              <td>
                <p>スタイリスト¥210,000~+歩合</p>
                <p>アシスタント¥165,000〜(試用期間あり期間中は¥160,000)</p>
              </td>
            </tr>
            <tr>
              <th>資格</th>
            ...
            <tr>
              <th>業務内容</th>
              <td>スタイリストの補助業務や店舗を円滑に運営するための多様な業務</td>
            </tr>
            <tr>
              <th>待遇</th>
              <td>
                <p>社会保険、厚生年金、交通費支給、賞与、昇給</p>
                <p>パート可。</p>
              </td>
            </tr>
          </tbody>
        </table>
        <div class="requirements_link">
          <p><a href="../entry/index.php">Entry</a></p>
        </div>
      </div>
    </div>
  </main>
