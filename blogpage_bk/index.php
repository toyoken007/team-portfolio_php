      ...
      <div class="newspage_main">
        ...
        <div class="newspage_img">
          <?php if (isset($imgfile)) : ?>
            <img src="../images/concept/<?php echo h($imgfile); ?>" alt="">
          <?php endif; ?>
        </div>
      ...
      <div class="news_guidance">
        <div class="category_box">
          ...
          <div class="category_news_box">
            <div class="category_news"> <a href="../news/index.ph">News</a></div>
          ...
          ?>
            ...
            <div class="recent_post_box">
              <div class="recent_post_img_box">
                <div class="recent_post_img"><img src="../images/concept/<?php echo h($imgfile); ?>" alt=""></div>
              </div>
